...
apt-get install -y ros-${ROS_DISTRO}-nav-core ros-${ROS_DISTRO}-navfn ros-${ROS_DISTRO}-teb-local-planner ros-${ROS_DISTRO}-grid-map ros-${ROS_DISTRO}-grid-map-ros ros-${ROS_DISTRO}-move-base ros-${ROS_DISTRO}-move-base-msgs 
